<template>
	<div class="loginPage w-100 bg-white">
		<div class="jump-reg">
			...
			<router-link :to="{path:'/regPhone/0',query:{mode: 'app'}}" class="jump-reg-link bg-white fs-3 blue">注册</router-link>
		</div>
...
<style lang="scss">
	.loginPage {
		...
		.blue{ color: #3d7efe !important; }
		.inputGroup-input input,.inputGroup-input input{ color: #000 !important; }
